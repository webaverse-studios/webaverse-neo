  ...
  constructor() {
    ...
    const _addYs = ( geometry ) => {
      ...
      for ( let i = 0; i < ys.length; i++ ) {
        ys[i] =
          1 - geometry.attributes.position.array[i * 3 + 1] / baseHeight
      }
    ...
    const topGeometry2 = new THREE.BoxGeometry(
      baseWidth2,
      baseHeight2,
      baseWidth2
    )
